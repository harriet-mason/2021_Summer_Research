...
SPLOM
```{r}
ggpairs(numbats_raw, columns=1:11, ggplot2::aes(colour=group, alpha=0.4))
```
- difficult to see anything because the blue group is over the top. Maybe with a smaller sample or soemthing I could see it. Can kind of tell its there though.
