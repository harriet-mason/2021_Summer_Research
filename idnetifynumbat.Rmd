...
bignumbatsA_scags_outrm <- calc_scags_wide(bignumbatsA, global_rng=c(0,1), out.rm=FALSE)  
bignumbatsB_scags_outrm <- calc_scags_wide(bignumbatsB, global_rng=c(0,1), out.rm=FALSE)
...
#combine into a single data frame
bignumbatsA_scags_outrm_long <- bignumbatsA_scags %>% 
  pivot_longer(cols=-c(Var1, Var2), names_to = "scag", values_to = "A_value")

bignumbatsB_scags_outrm_long <- bignumbatsB_scags %>% 
  pivot_longer(cols=-c(Var1, Var2), names_to = "scag", values_to = "B_value")
...
scag_noise_3 <- scagnoise_calc(20, TRUE, TRUE)
scag_noise_4 <- scagnoise_calc(20, TRUE, FALSE)
...
bignumbats_scags_wide_1 <- readRDS("wholesetscags.rds")

generateplot <- function(scag_data, bignumbats_scags_wide){
  #tidy true values
