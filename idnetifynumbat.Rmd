...
#try example with holes
#code from sherry's github
set.seed(123456)
holes_1d_better <- animate_dist(boa5, tour_path = guided_tour(holes(), 
                                                              d = 1, 
...
splines_2d_better_group %>% 
  explore_trace_interp() + 
  scale_color_continuous_botanical()

#compare geoskedastic and better
