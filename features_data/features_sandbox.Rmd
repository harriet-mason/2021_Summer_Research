...
anim_tourr(feature_vs_noise[1:5], feature_vs_noise$group, "skinny", "bet", 7, 0.7, 500, "anim")
saved_tour <- NULL
saved_anim <- readRDS("anim_skinny_bet_0.7_7_.rds")
last_frame(feature_vs_noise[1:5], feature_vs_noise$group, saved_anim)
