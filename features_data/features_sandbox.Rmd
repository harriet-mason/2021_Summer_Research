...
save_tourr <- function(numeric_data, group_vector, scag, search, filename, ...){
  ...
  #example
save_tourr(feature_vs_noise[1:5], feature_vs_noise$group, "skinny", "geo", "goodvibes.rds")
...
#example
goodvibes <- readRDS("C:/Users/harri/OneDrive/2021_Summer_Research/goodvibes.rds")
anim_tourr(feature_vs_noise[1:5], feature_vs_noise$group, goodvibes, "badvibes.rds")

c <- animate_xy(feature_vs_noise[1:5],
